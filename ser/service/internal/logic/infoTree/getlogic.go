...
func (l *GetLogic) Get(req *types.InfoTreeGetReq) (resp *types.InfoTreeGetResp, err error) {
	...
	InfoTree :=l.listToTree(treeRows,0)
...
func (l *GetLogic) listToTree(lis []*model.InfoTree, pid int64) []types.Leaf {
	var treeList []types.Leaf
	// 根据list中pid来获取元素
