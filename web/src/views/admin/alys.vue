                  ...
                  <v-col cols="12">
                    <p class="mb-0 text-body">
                      <span class="text-success text-sm font-weight-bolder"
                        >+55%</span
                      >
                      <span class="font-weight-light ms-1">七天增长率</span>
                    </p>
                  </v-col>
                </v-row>
              </v-card>
...
import CardWebsiteViews from "../../components/admin/CardWebsiteViews.vue";
import CardDailySales from "../../components/admin/CardDailySales.vue";
import CardCompletedTasks from "../../components/admin/CardCompletedTasks.vue";
