<template>
  <v-container fluid>
    ...
    >
      <span class="mask bg-gradient-info opacity-6" color="#6A76AB"></span>
    </div>
    <v-card
    ...
    >
      <v-row>
        <v-col cols="auto">
          <v-badge
            bordered
            bottom
            :color="userInfo.grade > 0 ? 'success' : 'grey '"
            icon="mdi-check"
            offset-x="20"
            offset-y="20"
          >
            <v-avatar width="80" height="80" class="shadow border-radius-lg">
              <img :src="userInfo.avt" alt="Avatar" class="border-radius-lg" />
            </v-avatar>
          </v-badge>
        </v-col>
        <v-col cols="auto" class="my-auto">
          <div class="h-100">
            ...
            <p class="mb-0 font-weight-light text-body text-sm">
              已参加：{{ userInfo.joinNum }}/ 已创建：{{ userInfo.createNum }}
            </p>
          </div>
        </v-col>
        <v-col lg="4" md="6" class="my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
          <v-tabs background-color="transparent" v-model="tab" right>
      ...
      <v-tabs-items v-model="tab">
        <v-tab-item> <info></info> </v-tab-item>
        <v-tab-item> <grade></grade> </v-tab-item>
        <v-tab-item> <mineFace></mineFace> </v-tab-item>
      </v-tabs-items>
    </v-card>
  </v-container>
</template>
...
import grade from "../../components/mine/grade.vue";
import mineFace from "../../components/mine/mineFace.vue";
