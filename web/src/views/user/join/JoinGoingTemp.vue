      ...
      <v-row>
        <v-col cols="12">
          <v-tabs-items v-model="tab" class="rounded-lg">
            <v-tab-item> <baseInfo></baseInfo></v-tab-item>
            <v-tab-item> <unitTree></unitTree></v-tab-item>
            <!-- <v-tab-item> <allRank></allRank></v-tab-item> -->
          </v-tabs-items>
        </v-col>
      </v-row>
    </v-card>
...
<script>
import baseInfo from "../../../components/join/baseInfo.vue";
import allRank from "../../../components/join/allRank.vue";
import unitTree from "../../../components/join/unitTree.vue";
