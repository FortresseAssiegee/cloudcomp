        ...
        <v-card class="mb-12" v-if="paTimeShow">
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="6">
                <v-radio-group v-model="examList[nowExam].userAnswer" column>
                  <v-radio
                    :label="n"
                    :value="n"
                    ...
                    :color="
                      showAnswer
                        ? n == examList[nowExam].answer
                          ? 'success'
                          : 'red'
                        : 'primary'
                    "
                    :disabled="diss && !(n == examList[nowExam].answer)"
                  ></v-radio>
                </v-radio-group>
              </v-col>
              <v-col cols="6">
